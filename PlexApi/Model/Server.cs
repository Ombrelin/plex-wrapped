...
namespace PlexApi.Model
{
    ...
    public class Server
    {
        ...
        [XmlAttribute(AttributeName = "port")] public int Port { get; set; }
        ...
        [XmlAttribute(AttributeName = "host")] public string Host { get; set; }
        ...
        [XmlAttribute(AttributeName = "home")] public int Home { get; set; }
    }
}